...
export const productHierarchy: ProductSeries[] = [
  ...
  },
  {
    ...
    image: { src: "/products/s-series/banner.png", alt: "AULMO S Series switches — black, gold, white, orange and gray" },
    heroStyle: "banner",
    cardImage: { src: "/products/s-series/s60/black/hero.png", alt: "AULMO S60 Series glass-panel switch, black" },
    subSeries: [
      {
        code: "S20",
        slug: "s20",
        name: "S20 Series",
        description: "Two-gang glass-panel switch offered across four finishes.",
        spec: "86 × 88 mm module",
        parameters: [
          { label: "Color", value: "White / Gray / Gold / Black" },
          { label: "Material (panel)", value: "PC" },
          { label: "Size", value: "86 × 88 mm" },
          { label: "Max. Current", value: "16A" },
          { label: "Max. Voltage", value: "250V" },
        ],
        familyImages: [
          { src: "/products/s-series/s20/brand-statement-dark.png", alt: "AULMO S20 Series brand statement", width: 1700, height: 2040 },
          { src: "/products/s-series/s20/brand-statement-light.png", alt: "AULMO S20 Series switch, silver gray, brand statement", width: 1700, height: 2290 },
          { src: "/products/s-series/s20/logo-detail.png", alt: "AULMO S20 Series logo detail", width: 1700, height: 1340 },
          { src: "/products/s-series/s20/brand-statement-gold.png", alt: "AULMO S20 Series switch, gold, brand statement", width: 1700, height: 2470 },
        ],
        variants: [
          {
            code: "black",
            name: "Black",
            swatch: "#17171A",
            hero: { src: "/products/s-series/s20/black/hero.png", alt: "AULMO S20 Series switch, black" },
            gallery: [
              { src: "/products/s-series/s20/black/detail.png", alt: "AULMO S20 Series switch detail, black", label: "Detail" },
              {
                src: "/products/s-series/s20/architecture.png",
                alt: "AULMO S20 Series dimension diagram, 86 x 88 mm",
                fit: "contain",
                label: "Dimensions",
              },
              {
                src: "/products/s-series/s20/profiling-diagram.png",
                alt: "AULMO S20 Series switch profiling diagram",
                fit: "contain",
                label: "Exploded View",
              },
            ],
          },
          {
            ...
            name: "Gold",
            swatch: "linear-gradient(105deg,#C9A053,#E8CB8C 46%,#A9803A)",
            hero: { src: "/products/s-series/s20/gold/hero.png", alt: "AULMO S20 Series switch, gold" },
            gallery: [
              {
                src: "/products/s-series/s20/architecture.png",
                alt: "AULMO S20 Series dimension diagram, 86 x 88 mm",
          ...
          },
          {
            ...
            name: "Gray",
            swatch: "#8B8D90",
            hero: { src: "/products/s-series/s20/gray/hero.png", alt: "AULMO S20 Series switch, gray" },
            gallery: [
              {
                src: "/products/s-series/s20/architecture.png",
                alt: "AULMO S20 Series dimension diagram, 86 x 88 mm",
          ...
          },
          {
            ...
            name: "White",
            swatch: "#F4F2ED",
            hero: { src: "/products/s-series/s20/white/hero.png", alt: "AULMO S20 Series switch, white" },
            gallery: [
              {
                src: "/products/s-series/s20/architecture.png",
                alt: "AULMO S20 Series dimension diagram, 86 x 88 mm",
      ...
      },
      {
        ...
        familyImages: [
          { src: "/products/s-series/s30/brand-statement.png", alt: "AULMO S30 Series switch and socket, brand statement", width: 1700, height: 2544 },
          { src: "/products/s-series/s30/brand-statement-gold.png", alt: "AULMO S30 Series switch, gold, brand statement", width: 1700, height: 2099 },
        ],
        variants: [
          {
            code: "white",
            name: "White",
            swatch: "#F4F2ED",
            hero: { src: "/products/s-series/s30/white/hero.png", alt: "AULMO S30 Series switch, white" },
            gallery: [
              { src: "/products/s-series/s30/white/detail.png", alt: "AULMO S30 Series switch detail, white", label: "Detail" },
              {
                src: "/products/s-series/s30/architecture.png",
                alt: "AULMO S30 Series dimension diagram, 86 x 88 mm",
                fit: "contain",
                label: "Dimensions",
              },
              {
                src: "/products/s-series/s30/materials-description.png",
                alt: "AULMO S30 Series material description and exploded view",
                fit: "contain",
                label: "Materials",
              },
            ],
          },
          {
            ...
            name: "Black",
            swatch: "#17171A",
            hero: { src: "/products/s-series/s30/black/hero.png", alt: "AULMO S30 Series switch, black" },
            gallery: [
              {
                src: "/products/s-series/s30/architecture.png",
                alt: "AULMO S30 Series dimension diagram, 86 x 88 mm",
          ...
          },
          {
            ...
            name: "Gold",
            swatch: "linear-gradient(105deg,#C9A053,#E8CB8C 46%,#A9803A)",
            hero: { src: "/products/s-series/s30/gold/hero.png", alt: "AULMO S30 Series switch, gold" },
            gallery: [
              {
                src: "/products/s-series/s30/architecture.png",
                alt: "AULMO S30 Series dimension diagram, 86 x 88 mm",
          ...
          },
          {
            ...
            name: "Gray",
            swatch: "#8B8D90",
            hero: { src: "/products/s-series/s30/gray/hero.png", alt: "AULMO S30 Series switch, gray" },
            gallery: [
              {
                src: "/products/s-series/s30/architecture.png",
                alt: "AULMO S30 Series dimension diagram, 86 x 88 mm",
      ...
      //{ code: "S50", slug: "s50", name: "S50 Series", description: "S50 module in the AULMO S Series glass-panel switch and socket range." },
      {
        ...
        slug: "s60",
        name: "S60 Series",
        description: "Crystal glass panel switch and socket range, offered across five finishes.",
        spec: "86 × 92 mm module",
        parameters: [
          { label: "Color", value: "Black / Gray / Gold / White / Red" },
          { label: "Material (panel)", value: "PC+Acrylic" },
          { label: "Size", value: "86 × 92 mm" },
          { label: "Max. Current", value: "16A" },
          { label: "Max. Voltage", value: "250V" },
        ],
        familyImages: [
          { src: "/products/s-series/s60/brand-statement.png", alt: "AULMO S60 Series switch, black, brand statement", width: 1700, height: 2376 },
          { src: "/products/s-series/s60/brand-statement-red.png", alt: "AULMO S60 Series switch and socket, red, brand statement", width: 1700, height: 2335 },
          { src: "/products/s-series/s60/lifestyle-couple.png", alt: "AULMO S60 Series lifestyle, black", width: 1700, height: 1389 },
          { src: "/products/s-series/s60/lifestyle-desk.png", alt: "AULMO S60 Series switch installed, gray", width: 1700, height: 2071 },
        ],
        variants: [ 
          {
            code: "gold",
            name: "Gold",
            swatch: "linear-gradient(105deg,#C9A053,#E8CB8C 46%,#A9803A)",
            hero: { src: "/products/s-series/s60/gold/hero.png", alt: "AULMO S60 Series glass-panel switch, gold" },
            gallery: [
              {
                src: "/products/s-series/s60/architecture.png",
                alt: "AULMO S60 Series dimension diagram, 86 x 92 mm",
                fit: "contain",
                label: "Dimensions",
              },
              {
                src: "/products/s-series/s60/profiling-diagram.png",
                alt: "AULMO S60 Series switch profiling diagram",
                fit: "contain",
                label: "Exploded View",
              },
            ],
          },
          {
            ...
            name: "Black",
            swatch: "#17171A",
            hero: { src: "/products/s-series/s60/black/hero.png", alt: "AULMO S60 Series glass-panel switch, black" },
            gallery: [
              {
                src: "/products/s-series/s60/architecture.png",
                alt: "AULMO S60 Series dimension diagram, 86 x 92 mm",
          ...
          },
          {
            ...
            name: "Gray",
            swatch: "#8B8D90",
            hero: { src: "/products/s-series/s60/gray/hero.png", alt: "AULMO S60 Series glass-panel switch, gray" },
            gallery: [
              { src: "/products/s-series/s60/gray/detail.png", alt: "AULMO S60 Series switch detail, gray", label: "Detail" },
              {
                src: "/products/s-series/s60/architecture.png",
                alt: "AULMO S60 Series dimension diagram, 86 x 92 mm",
                fit: "contain",
          ...
          },
          {
            ...
            name: "White",
            swatch: "#F4F2ED",
            hero: { src: "/products/s-series/s60/white/hero.jpg", alt: "AULMO S60 Series glass-panel switch, white" },
            gallery: [
              {
                src: "/products/s-series/s60/architecture.png",
                alt: "AULMO S60 Series dimension diagram, 86 x 92 mm",
          ...
          },
          {
            ...
            name: "Red",
            swatch: "#C1272D",
            hero: { src: "/products/s-series/s60/red/hero.png", alt: "AULMO S60 Series glass-panel switch, red" },
            gallery: [
              { src: "/products/s-series/s60/red/detail.png", alt: "AULMO S60 Series switch detail, red", label: "Detail" },
              {
                src: "/products/s-series/s60/architecture.png",
                alt: "AULMO S60 Series dimension diagram, 86 x 92 mm",
                fit: "contain",
      ...
      //{ code: "S80", slug: "s80", name: "S80 Series", description: "S80 module in the AULMO S Series glass-panel switch and socket range." },
      {
        ...
        slug: "s90",
        name: "S90 Series",
        description: "Tempered-glass panel switch offered across four finishes.",
        spec: "86 × 88 mm module",
        parameters: [
          { label: "Color", value: "Black / Blue / Orange / Wine red" },
          { label: "Material (panel)", value: "PC+Tempered Glass" },
          { label: "Size", value: "86 × 88 mm" },
          { label: "Max. Current", value: "16A" },
          { label: "Max. Voltage", value: "250V" },
        ],
        familyImages: [
          { src: "/products/s-series/s90/brand-statement.png", alt: "AULMO S90 Series brand statement", width: 1700, height: 1242 },
        ...
        variants: [
          {
            ...
            name: "Black",
            swatch: "#17171A",
            hero: { src: "/products/s-series/s90/black/hero.png", alt: "AULMO S90 Series switch, black" },
            gallery: [
              { src: "/products/s-series/s90/black/detail.png", alt: "AULMO S90 Series switch detail, black", label: "Detail" },
              {
          ...
          },
          {
            ...
            name: "Blue",
            swatch: "#7FA8C9",
            hero: { src: "/products/s-series/s90/blue/hero.png", alt: "AULMO S90 Series switch, blue" },
            gallery: [
              { src: "/products/s-series/s90/blue/detail.png", alt: "AULMO S90 Series switch detail, blue", label: "Detail" },
              {
                src: "/products/s-series/s90/architecture.png",
                alt: "AULMO S90 Series dimension diagram, 86 x 88 mm",
                fit: "contain",
          ...
          },
          {
            code: "orange",
            name: "Orange",
            swatch: "linear-gradient(105deg,#F0854A,#F7A874 46%,#D5642A)",
            hero: { src: "/products/s-series/s90/orange/hero.png", alt: "AULMO S90 Series switch, orange" },
            gallery: [
              { src: "/products/s-series/s90/orange/detail.png", alt: "AULMO S90 Series switch detail, orange", label: "Detail" },
              {
                src: "/products/s-series/s90/architecture.png",
                alt: "AULMO S90 Series dimension diagram, 86 x 88 mm",
                fit: "contain",
